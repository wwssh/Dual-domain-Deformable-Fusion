...
class SegTemplate(nn.Module):
    def __init__(self, constructor, feat_extract_layer, num_classes, pretrained_path=None, aux_loss=None):
        ...
        self.pretrained_path = '/home/wsh/research_project/OpenPCDet2-master/checkpoints/deeplabv3_resnet50_coco-cd0a2569.pth'
        ...
        # Model
        self.model = self.get_model_v1(constructor=constructor)
    ...
    def get_model_v1(self, constructor):
        """
        Get model
        Args:
            constructor: function, Model constructor
        ...
        """
        # Get model
        model = CustomBackbone(constructor(pretrained=False,
                            pretrained_backbone=False,
                            num_classes=self.num_classes,
                            aux_loss=self.aux_loss).backbone)

        new_model = nn.Module()
        new_model.add_module('backbone', model)
        # Update weights
        if self.pretrained_path is not None:
...
class CustomBackbone(nn.Module):
    def __init__(self, original_backbone):
        ...
        self.conv1 = original_backbone.conv1
        self.bn1 = original_backbone.bn1
        self.relu = original_backbone.relu
        self.maxpool = original_backbone.maxpool
